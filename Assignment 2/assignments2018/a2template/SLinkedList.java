...
public class SLinkedList<E extends DeepClone<E>> implements Iterable<E>
{
	...
	/**
	 *    Show all elements in list.    Alternatively I could have overridden the toString() method and then
	...
	/*
 	 *  TODO: Makes a deep copy of this linked list.
 	 *  Hint: Use E.deepClone().
 	 */
