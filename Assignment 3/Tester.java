...
public class Tester {
    ...
    public static String base = localDir+"/"; //You might need to change these based on your operating system. (Unless you are working on Ubuntu 16.04)
    public static String basedb = localDir+"/db/";  //You might need to change these based on your operating system. (Unless you are working on Ubuntu 16.04)
